...
all:
	...
	riscv64-unknown-elf-ld -T boot/linker.ld -L$(IDRIS_LIB) -L$(IDRIS_SUPPORT) -nostdlib build/exec/kernel.o  $(BOOTOBJS) --whole-archive -lidris2_urefc -lidris_support -o kernel.elf
